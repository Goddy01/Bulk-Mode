...
export default function ExerciseCard(props) {
    ...
    return (
        <div className='p-4 rounded-md flex flex-col gap-4 bg-sky-800 sm:flex-wrap'>
            ...
            <div className='flex flex-col bg-sky-800 rounded gap-2 '>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-4 sm:place-items-center gap-2'>
                ...
                <button onClick={handleSetIncrement} className='flex flex-col p-2 rounded border-[1.5px] duration-200 border-solid border-blue-900 hover:border-blue-600 w-full duration-200 bg-slate-900'>
